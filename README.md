...
The game gives you a letter-scrambled title of a recent news article. Your goal is to unscramble the title in as few steps as possible (primarily), as quickly as possible (secondarily).

## Play the game

Play the game live in your webbrowser [on itch](https://theduckcow.itch.io/who-knows-the-news)!

Some workarounds had to be made in order for CORS to access the Google News RSS feed, and these workarounds might not be in place forever. At the very least, you can go through some built in puzzles packaged with the game (right now, this just consists of the tutorial stages).
